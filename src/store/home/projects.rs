...
pub fn get_projects() -> Vec<Project> {
    vec![
        ...
        Project {
            ...
            clean_tags: vec!["web".to_string(), "puzzle-game".to_string(), "react-hooks".to_string()],
            stars: 22,
            forks: 13,
            icon: "∞".to_string(),
            links: {
        ...
        Project {
            ...
            clean_tags: vec!["web".to_string(), "cross-platform".to_string(), "screenshot-capture".to_string()],
            stars: 2,
            forks: 1,
            icon: "◊".to_string(),
            links: {
        ...
        Project {
            ...
            short_description: "Multi-agent CLI for orchestrated Claude Code workflows".to_string(),
            description: "A powerful CLI tool for running multiple Claude Code agents in parallel with orchestrated workflows. Built with Rust for maximum performance, enabling complex multi-agent task coordination and parallel processing for enhanced AI-assisted development.".to_string(),
            tags: vec!["rust".to_string(), "cli".to_string(), "ai".to_string(), "multi-agent".to_string(), "claude".to_string(), "developer-tools".to_string()],
            clean_tags: vec!["rust".to_string(), "cli".to_string(), "ai".to_string(), "developer-tools".to_string()],
            stars: 1,
            forks: 0,
            icon: "◉".to_string(),
            links: {
        ...
        Project {
            ...
            clean_tags: vec!["web".to_string(), "game".to_string(), "cli".to_string()],
            stars: 1,
            forks: 0,
            icon: "⬡".to_string(),
            links: {
