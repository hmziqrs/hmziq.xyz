    ...
    vec![
        Project {
            ...
            links: {
                ...
                links.insert("personal".to_string(), "https://hmziq.rs/".to_string());
                links.insert("twitter".to_string(), "https://twitter.com/hmziqrs".to_string());
                links.insert("telegram".to_string(), "https://t.me/hmziqrs".to_string());
                links
            },
            number: 1,
        },
        Project {
            ...
            links: {
                ...
                links.insert("playstore".to_string(), "https://play.google.com/store/apps/details?id=com.onemdev.invmovieconcept1".to_string());
                links
            },
            number: 2,
        },
        ...
        Project {
            ...
            links: {
                ...
                links.insert("twitter".to_string(), "https://x.com/hmziqrs".to_string());
                links.insert("telegram".to_string(), "https://t.me/hmziqrs".to_string());
                links.insert("website".to_string(), "https://hmziq.rs".to_string());
                links.insert("github_releases".to_string(), "https://github.com/hmziqrs/gandalf-sax/releases".to_string());
                links
            },
            number: 10,
        },
        Project {
            ...
            links: {
                ...
                links.insert("nextjs_docs".to_string(), "https://nextjs.org/docs".to_string());
                links.insert("nextjs_learn".to_string(), "https://nextjs.org/learn".to_string());
                links.insert("nextjs_github".to_string(), "https://github.com/vercel/next.js/".to_string());
                links.insert("vercel_deploy".to_string(), "https://vercel.com/new?utm_medium=default-template&filter=next.js&utm_source=create-next-app&utm_campaign=create-next-app-readme".to_string());
                links.insert("deployment_docs".to_string(), "https://nextjs.org/docs/deployment".to_string());
                links
            },
            number: 11,
        },
